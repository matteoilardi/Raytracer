...
int main() {
  ...
  assert(are_close(color2 + color3, Color(5.0, 17.0, 13.0)));
  assert(!are_close(color2 + color3, Color(5.0, 16.0, 13.5)));

  assert(are_close(color2 * color3, Color(4.0, 60.0, 42.0)));

  assert(are_close(f1 * color2, Color(6.0, 7.5, 9.0)));
  assert(are_close(color2 * f1, Color(6.0, 7.5, 9.0)));
  ...
  assert(image1._pixel_offset(9, 5) == (5 + 9 * image1.width));
